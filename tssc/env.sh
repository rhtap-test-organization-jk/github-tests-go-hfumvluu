...
export IMAGE_URL=${IMAGE_URL-quay.io/rhtap_qe/github-tests-go-hfumvluu:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/github-tests-go-hfumvluu-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFaUhibDBOZlREbUw3ajZ2djFoVWVDb1FkTGpKawpISWRZdllpZktUNkxZM3JhVktTVnFKQnVFMjVJSFFVRTFVZXN5bEdIZHVyYVdpL1RrY3lTWHpCcFl3PT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.cluster-jzz62.jzz62.sandbox956.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.cluster-jzz62.jzz62.sandbox956.opentlc.com}
